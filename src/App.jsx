      ...
      {!showWarning && (
        <div className={`w-screen min-h-screen bg-gray-300 wii-cursor select-none transition-opacity duration-300 fade-in`}>
          <div className={` w-screen min-h-screen bg-[repeating-linear-gradient(0deg,_#fff,_#fff_1px,_transparent_1px,_transparent_5px)]`}>
            <section className={`${envelopeMenu ? '-translate-y-full' : 'translate-y-0'} transition-all duration-700 flex justify-center wii-cursor`}>
          ...
          : 'opacity-0 scale-100 pointer-events-none z-0'
                    ...
                    >
                      <span className="text-gray-500">Wii {i + 1}</span>
                    </div>
                  )}
                  </div>
                ))}
            ...
            <section>
              <div className={`${envelopeMenu ? '-translate-y-[650px]' : 'translate-y-0'} transition duration-750 flex justify-center items-end wii-cursor`}>
            ...
            <section>
              <div className="bg-gray-300 border-t-3 border-blue-400 h-screen flex justify-between inset-shadow-sm wii-cursor">
                <div className="bg-gray-300 border-4 border-gray-400 rounded-full w-sm h-40 p-5 flex justify-end -translate-x-50 text-center translate-y-6">
                  <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="text-gray-400 rounded-full bg-gray-300 border-4 border-blue-400 w-30 h-30 flex justify-center items-center font-semibold text-4xl shadow-2xl -translate-x-6 hover:border-blue-400 hover:shadow-[0_0_10px_rgba(59,130,246,0.7)] transition-all duration-300 hover:scale-110">Wii</div>
                </div>
                <h1 className="text-gray-500 font-semibold text-5xl mt-2">{dayWeek} {month}/{date}</h1>
                <div className={` translate-x-50 translate-y-6`}>
                  <div className={`${isEnvelopeAnimating ? 'rotate-180' : 'rotate-0'} transition-all duration-300 bg-gray-300 border-4 border-gray-400 rounded-full w-sm h-40 p-5 flex justify-between text-center`}>
                    <div onClick={() => changeToEnvelopeMenu()} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="rounded-full bg-gray-300 border-4 border-blue-400 w-30 h-30 flex justify-center items-center font-semibold text-5xl shadow-2xl translate-x-6 hover:border-blue-400 hover:shadow-[0_0_10px_rgba(59,130,246,0.7)] transition-all duration-300 hover:scale-110">
                    ...
                    <div onClick={() => changeToEnvelopeMenu()} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className={`rotate-180 ease-in-out rounded-full bg-gray-300 border-4 border-blue-400 w-30 h-30 flex justify-center items-center  text-4xl shadow-2xl -translate-x-6 translate-y-[37px] hover:border-blue-400 hover:shadow-[0_0_10px_rgba(59,130,246,0.7)] transition-all duration-300 hover:scale-110`}>
                      <span className={` bg-gray-400 text-gray-300 rounded-xl font-semibold !py-2 !px-3`}>Wii</span>
                    </div>
                  </div>
                </div>
              </div>
