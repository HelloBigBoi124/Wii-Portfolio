...
function App() {
  ...
  const zoomInApp = () => {
    const audio = new Audio('/src/sound/zoom-in-app.mp3');
    audio.volume = 0.3;
    audio.play();
  }

  const zoomOutApp = () => {
    const audio = new Audio('/src/sound/zoom-out-app.mp3');
    audio.volume = 0.3;
    audio.play();
  }

  const hoverBtnMenuApp = () => {
    const audio = new Audio('/src/sound/hover-menu-app-btn.mp3');
    audio.volume = 0.3;
    audio.play();
  }

  const clickedStartBtn = () => {
    const audio = new Audio('/src/sound/start-app-sound.mp3');
    audio.volume = 0.3;
    audio.play();
  }
